...
<!-- CSS  -->
    ...
    <link href="css/maintest.css" type="text/css" rel="stylesheet" media="screen"/>
</head>
...
<p> Title </p>
<input type="text" name="formTitle" maxlength="100" placeholder="Enter title"  value="<?=$vartTitle;?>"  >
...
<p> Link </p>
<input type="text" name="formLink" maxlength="100" value="<?=$varLink;?>" >
